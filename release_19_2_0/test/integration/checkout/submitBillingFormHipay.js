...
describe('billingForm', function () {
    ...
    describe('submit billing form', function () {
        ...
        it('should submit billing form successfully', function () {
            myRequest.form = {
                ...
                dwfrm_billing_addressFields_email: 'blahblah@gmail.com',
                dwfrm_billing_paymentMethod: 'HIPAY_CREDIT_CARD',
            ...
            var ExpectedResBody = {
                ...
                paymentMethod: { value: 'HIPAY_CREDIT_CARD', htmlName: 'HIPAY_CREDIT_CARD' },
